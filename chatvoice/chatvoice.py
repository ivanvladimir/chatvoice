...
@click.pass_context
def chatvoice(ctx,config_filename="config.ini",config_section="DEFAULT",verbose=False):
    global config
...
@optgroup.option("--speech-recognition-dir",
        default=config.get(CONFIG_SECTION,'speech_recognition_dir',fallback='speech_recognition'),
        type=click.Path(),
...
@chatvoice.command()
@click.argument("conversations-dir", type=click.Path(exists=True), default="conversations")
